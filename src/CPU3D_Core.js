...
// Properites
///////////////////////////////////////////////////////////////////////////////
CPU3D_Core.prototype.pixelBuffer;
CPU3D_Core.prototype.pixelBuffer_Uint8;
CPU3D_Core.prototype.pixelBuffer_Uint32;		//used to edit the pixel data as we have 32-bit color
CPU3D_Core.prototype.pixelBufferIntial_Uint32;	//This is the default image we load into the buffer.

CPU3D_Core.prototype.depthBuffer_Float32;		//a Float32Array that holds the depth buffer
CPU3D_Core.prototype.depthBufferIntial_Float32;	//This is a blank depth buffer that is copied in at the start of rendering.

CPU3D_Core.prototype.vertexBank;			//Stores the model data for each object
CPU3D_Core.prototype.textureBank;			//Stores the texture data for each material
CPU3D_Core.prototype.defaultTexture;		//Stores the blank texture used when the real texture is still loading or not found

CPU3D_Core.prototype.shaderBank;			//Stores each of the shader objects

CPU3D_Core.prototype.width;					//Width of the rendering
CPU3D_Core.prototype.height;				//Hieght of the rendering

CPU3D_Core.prototype.viewportMatrix;		//Stores the viewport matrix for the render. Updated with screen size changes.

CPU3D_Core.prototype.polygon;		//Stores a persisent Polygon_2D object

///////////////////////////////////////////////////////////////////////////////
// Input Constants
//////////////////////////////////////////////////////////////////////////////
CPU3D_Core.prototype.TEXTURE_0;		//Reference to the current Texture being used.
CPU3D_Core.prototype.TEXTURE_1;
CPU3D_Core.prototype.TEXTURE_3;
CPU3D_Core.prototype.TEXTURE_4;
CPU3D_Core.prototype.TEXTURE_5;
CPU3D_Core.prototype.TEXTURE_6;
CPU3D_Core.prototype.TEXTURE_7;

CPU3D_Core.prototype.CONT_TEXTURE_COUNT = 8;

CPU3D_Core.prototype.SHADER_shader0;	//Reference to the current shader being used.

///////////////////////////////////////////////////////////////////////////////
// Globals
///////////////////////////////////////////////////////////////////////////////
CPU3D_Core.prototype.PROP_ENABLE_TRIANGLE_OVERSCAN = false;
CPU3D_Core.prototype.PROP_ENABLE_BACKFACECULL = true;
CPU3D_Core.prototype.PROP_ENABLE_TRIANGLE_OUTLINE = false;
CPU3D_Core.prototype.PROP_ENABLE_Z_BUFFER = true;

CPU3D_Core.prototype.PROP_CLEAR_COLOUR = (0 << 24) | (0 << 16) | (0 <<  8) | 0;
...
CPU3D_Core.prototype.CONT_USING_UINT8CLAMPED;

///////////////////////////////////////////////////////////////////////////////
// Constructor
///////////////////////////////////////////////////////////////////////////////
CPU3D_Core.prototype.core = function() {	
	return;
}
...
CPU3D_Core.prototype.initialise = function(width, height, startY, endY, uintClamped) {
...
CPU3D_Core.prototype.resetScreen = function(width, height, startY, endY) {
...
CPU3D_Core.prototype.generateIntialPixelBuffer = function() {
...
CPU3D_Core.prototype.updateUint8Clamped = function(Uint8Clamped) {
...
CPU3D_Core.prototype.clearColor = function(red, green, blue, alpha) {	
	this.PROP_CLEAR_COLOUR = (alpha << 24) | (blue << 16) | (green <<  8) | red;
	this.generateIntialPixelBuffer();
	return;
}

CPU3D_Core.prototype.draw = function(vbo, start, length) {
	...
	this.polygon = new this.CPU3D_Polygon();
...
CPU3D_Core.prototype.pipeline = function(faceVertices) {
...
CPU3D_Core.prototype.generateEdges = function(vertices) {
...
CPU3D_Core.prototype.createEdge;

//Mupltiple versions of this function are generated and the code for it is within the shader file.
CPU3D_Core.prototype.scanline;

CPU3D_Core.prototype.getTexturePixelColor = function(x, y, texture) {
...
CPU3D_Core.prototype.setPixelIndex = function(array, i, red, green, blue, alpha) {
	array[i] =
		(alpha << 24) |	// alpha
		(blue << 16) |	// blue
		(green << 8) |	// green
...
CPU3D_Core.prototype.pointToIndex = function(x, y) {
	return (y * this.width) + x;
}

CPU3D_Core.prototype.getRandomColor = function() {
...
*/
CPU3D_Core.prototype.insideFrustum = function(vertices) {
...
*/
CPU3D_Core.prototype.UVMapAdjustment = function(vertices) {
 ...
 */
CPU3D_Core.prototype.clipNearPlane = function(vertexVectors, clippingValue) {
 ...
 */
CPU3D_Core.prototype.perspectiveDivision = function(vertices) {
 ...
 */
CPU3D_Core.prototype.backfaceCull = function(vertex1, vertex2, vertex3) {
 ...
 */
CPU3D_Core.prototype.viewportTransform = function(vertices) {
...
CPU3D_Core.prototype.roundScreenValues = function(vertices) {
...
CPU3D_Core.prototype.createViewportMatrix = function(x, y, width, height) {	
	var result = new this.CPU3D_Matrix();	
...
CPU3D_Core.prototype.getVBOId = function() {
 ...
 */
CPU3D_Core.prototype.loadVBO = function(vboID, vertexData) {
...
CPU3D_Core.prototype.clearVBO = function(vboID) {
	this.vertexBank[vboID] = null;
	return;
}

CPU3D_Core.prototype.getTBOId = function() {
...
CPU3D_Core.prototype.loadTBO = function(tboID, data, width, height) {
...
CPU3D_Core.prototype.bindTBO = function(textureSlot, textureIndex) {
...
CPU3D_Core.prototype.clearTBO = function(tboID) {
...
CPU3D_Core.prototype.textureCheck = function(id, functionName) {
...
CPU3D_Core.prototype.getSBOId = function() {
	...
	this.shaderBank.push(new this.CPU3D_Shader(this, shaderID));
	return shaderID;
}

CPU3D_Core.prototype.loadSBO = function(shaderID) {
...
CPU3D_Core.prototype.bindSBO = function(shaderID) {
	if (shaderID == 0) {
...
CPU3D_Core.prototype.clearSBO = function(shaderID) {	
...
CPU3D_Core.prototype.assignSBOVertexFunction = function(shaderID, vertexFunction) {
...
CPU3D_Core.prototype.assignSBOPixelFunction = function(shaderID, pixelFunction) {
...
CPU3D_Core.prototype.addSBOVertexAttribute = function(shaderID, shader, type, length) {
...
CPU3D_Core.prototype.shaderCheck = function(shaderID, functionName) {
...
CPU3D_Core.prototype.vecByMatrixCol = function(vector, matrix, offset) {
...
CPU3D_Core.prototype.vecByMatrixRow = function(vector, matrix, offset) {
 ...
 */
CPU3D_Core.prototype.multiplyVectorWithMatrixViewportTransform = function(vector, m2) {
...
CPU3D_Core.prototype.getDifference = function(n1, n2) {
	if (n1 >= 0 && n2 >= 0) {
...
CPU3D_Core.prototype.getCardinalDifference = function(x1, y1, x2, y2) {
...
CPU3D_Core.prototype.getCardinalDifference3D = function(x1, y1, z1, x2, y2, z2) {
	var s1 = this.getDifference(x1, x2);
	var s2 = this.getDifference(y1, y2);
...
CPU3D_Core.prototype.drawLine = function(x1, x2, y1, y2) {
