...
class CPU3D_Polygon {
	...
	// Properites
	///////////////////////////////////////////////////////////////////////////////
	#vertices;	//a list of the vertices, stored as vectors

	#vertexLength; //store how long a vertex is
	#verticesLength;
	#currentPosition;
	...
	// Functions
	///////////////////////////////////////////////////////////////////////////////
	createPoylgon = function(vertices, width, height) {
	 ...
	 */
	withinFrame = function(vertices, width, height) {	
	 ...
	 */
	outOfFrame = function(vertices, width, height) {	
		var left = 0;
		var right = 0;
		var top = 0;
		var bottom = 0;
	...
	clipPolygon = function(vertices, width, height) {	
		var verticesOutput;
		var v0;
		var v1;
		var v2;
	...
	clippingCheck = function(v1, v2, value, side) {
	...
	*/
	verticesModify = function(v1, v2, b1x, b1y, b2x, b2y, clip, output) {
		if (clip == 0) {
	...
	getIntersection = function(v1, v2, b1x, b1y, b2x, b2y) {
		var x;
		var y;
