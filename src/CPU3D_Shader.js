...
class CPU3D_Shader {
	...
	#inputCount; //only need count. Types dont matter as user gets to choose what they do with them.
	#outputCount; //only need count. Types dont matter as user gets to choose what they do with them.
	...
	setVertexFunction = function(vertexFunction) {
	...
	setPixelFunction = function(pixelFunction) {
	...
	addSBOVertexAttribute = function(shader, type, length) {
	...
	vertexLoopCreation = function(shaderID) {
	...
	createEdgeCreation = function(propertiesList, shaderID) {
		var xIndex = 0;
		var yIndex = 1;
	...
	scanlineCreation = function(propertiesList, shaderID) {
